...
CUSTOMER_NAME = "ASG - MH-Ultimate"
CUSTOMER_DB_NAMES = "MH-Ultimate Demonstration Data"
...
central_script_path = os.path.join(base_dir, "metabase_update_scripts", "update_snapshot_monthly.py")
