...
log_file_path = os.path.join(os.path.dirname(__file__), "update_log.log")
...
sql_file_path = os.path.join(os.path.dirname(__file__), "update_script_nvision.sql")
...
try:
    ...
    command = [
        ...
        "-S", "66.97.130.194,50366",  # Server and port
        "-U", "jobxcel",              # Username
        "-P", "6wXJrWbaMJGJDbYpwWzm", # Password
