...
CREATE TABLE ',@Reporting_DB_Name,'.dbo.',QUOTENAME('Change_Order_Lines_Pivot'), '(
...
INSERT INTO ',@Reporting_DB_Name,'.dbo.',QUOTENAME('Change_Order_Lines_Pivot'),' 
...
SELECT 
	...
	SUM(cl.bdgprc) as change_amount,
...
GROUP BY c.recnum, c.chgnum, c.chgdte, jobnum, a.jobnme, c.phsnum, c.status, c.dscrpt, ct.typnme, reason, subdte, aprdte, invdte, c.pchord, cl.cstcde, cst.typnme, c.insdte,c.upddte
')
