...
--Create Committed Costs View
DECLARE @SqlViewQuery NVARCHAR(MAX);
DECLARE @SqlViewQuery1 NVARCHAR(MAX);
DECLARE @SqlViewQuery2 NVARCHAR(MAX);
SET @SqlViewQuery1 = N' 
...
SET @SqlViewQuery = @SqlViewQuery1 + @SqlViewQuery2
EXECUTE sp_executesql @SqlViewQuery